...
<div class="page-ath-wrap" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '70vh' }}>
        <div class="page-ath-content">
            ...
            <div class="page-ath-text">
                <h2 class="page-ath-heading">Thank you! <small>Your singup process is done.</small> <span class="text-success">Please go to the next step and fill in your personal details.</span></h2><Link to="/profile"><strong style={{ textDecoration: 'underline', fontSize: '1.4em' }}>Here</strong></Link>
            </div>
